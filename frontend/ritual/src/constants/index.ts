...
export const MIN_NATIVE_CURRENCY_FOR_GAS: {
  ...
  [ChainId.CYBERIA]: JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(16)), // 0.01 CYBER
};
...
// Ritual on Cyberia: we only bundle our own token list. External Coingecko
// feeds are skipped because they don't cover chainId 49406.
export const DEFAULT_LIST_OF_LISTS: string[] = [
  GlobalConst.utils.DEFAULT_TOKEN_LIST_URL,
];

export const SUPPORTED_CHAINIDS = [ChainId.CYBERIA];
