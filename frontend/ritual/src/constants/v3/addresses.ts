...
const WETH_ONLY: ChainTokenList = {
  ...
  [ChainId.CYBERIA]: [WETH[ChainId.CYBERIA]],
};
...
export const V2_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.CYBERIA]: '0xB0aC30907c04b61F1482e62eA66eF4562a690917',
};
...
export const EXCHANGE_PAIR_INIT_HASH_MAPS: ExchangeAddressMap = {
  [V2Exchanges.Quickswap]: {
    ...
    [ChainId.CYBERIA]:
      '0x927cde9487326a3f34732433099d68bf5a9880cdbb4316b3b80960c66e094580',
  },
  [V2Exchanges.SushiSwap]: {
    [ChainId.MATIC]:
...
export const V2_ROUTER_ADDRESS: AddressMap = {
  ...
  [ChainId.CYBERIA]: '0x8bECfB12Ab113586D8deD3D343aEfFd8eD54FD62',
};
...
export const NEW_QUICK: { [chainId: number]: Token } = {
  [ChainId.CYBERIA]: new Token(
    ChainId.CYBERIA,
    NEW_QUICK_ADDRESS[ChainId.CYBERIA],
    18,
    'ASH',
    'Ash',
  ),
...
export const V3_BASES_TO_CHECK_TRADES_AGAINST: {
  ...
  [ChainId.MINATO]: [
    WMATIC_EXTENDED[ChainId.MINATO],
...
export const wrappedTokenAddresses: {
  ...
  [ChainId.CYBERIA]: WETH[ChainId.CYBERIA].address,
};
