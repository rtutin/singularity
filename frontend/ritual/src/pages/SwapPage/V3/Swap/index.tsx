  ...
  return (
    <>
      <Helmet>
        <meta
          name={'description'}
          content={`Ritual — the sacrificial DEX on Cyberia. Every swap burns an offering; out of the fire rises Ash. Trade CYBER, WCYBER and ASH on-chain.`}
        />
        <meta
          name={'keywords'}
          content={`ritual, ash, cyberia, dex, cyber, wcyber, defi, cyberia swap, sacrificial dex`}
        />
      </Helmet>
      <TokenWarningModal
