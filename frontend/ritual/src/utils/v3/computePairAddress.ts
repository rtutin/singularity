...
export const computePairAddress = ({
  ...
  const factoryAddress =
    EXCHANGE_FACTORY_ADDRESS_MAPS[exchange][tokenA.chainId] ??
    EXCHANGE_FACTORY_ADDRESS_MAPS[exchange][137];
  const initHash =
    EXCHANGE_PAIR_INIT_HASH_MAPS[exchange][tokenA.chainId] ??
    EXCHANGE_PAIR_INIT_HASH_MAPS[exchange][137];
