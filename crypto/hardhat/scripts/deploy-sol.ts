...
const artifact = JSON.parse(
  fs.readFileSync("./artifacts/contracts/SOL.sol/SOL.json", "utf8"),
);
...
// Optional override: SOL_OWNER env var (defaults to deployer).
const owner = (process.env.SOL_OWNER ?? walletClient.account.address) as `0x${string}`;

console.log("Deploying SOL...");
...
console.log("SOL deployed at:", receipt.contractAddress);
