...
const artifact = JSON.parse(
  fs.readFileSync("./artifacts/contracts/BTC.sol/BTC.json", "utf8"),
);
...
// Optional override: BTC_OWNER env var (defaults to deployer).
const owner = (process.env.BTC_OWNER ?? walletClient.account.address) as `0x${string}`;
...
console.log("BTC deployed at:", receipt.contractAddress);
