...
const artifact = JSON.parse(
  fs.readFileSync("./artifacts/contracts/LTC.sol/LTC.json", "utf8"),
);
...
// Optional override: LTC_OWNER env var (defaults to deployer).
const owner = (process.env.LTC_OWNER ?? walletClient.account.address) as `0x${string}`;

console.log("Deploying LTC...");
...
console.log("LTC deployed at:", receipt.contractAddress);
